...
import static me.gnat008.naxoshomes.TestUtils.getJarFile;
 ...
 */
public class SettingsConsistancyTest
{

    /** Bukkit's FileConfiguration#getKeys returns all inner nodes also. We want to exclude those in tests. */
    private static final List<String> YAML_INNER_NODES = ImmutableList.of("");

    private final ConfigurationData configData = ConfigurationDataBuilder.collectData(CoreProperties.class);
